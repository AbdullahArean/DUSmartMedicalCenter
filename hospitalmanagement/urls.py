...
urlpatterns = [
    ...
    path('', views.home_view.as_view(), name=''),

    path('aboutus', views.aboutus_view),
    path('contactus', views.contactus_view),

    path('adminclick', views.adminclick_view.as_view()),
    path('doctorclick', views.doctorclick_view.as_view()),
    path('patientclick', views.patientclick_view.as_view()),
